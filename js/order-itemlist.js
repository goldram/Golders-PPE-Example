...
function OrderItemList() {
    ...
    this.AddOrderItem = function(oData, bCustom) {
        ...
        if (bCustom !== true) {                
            ...
            //sMsg += "the Products window and then submit/save the changes.";
            alert(sMsg);
            
        }
        else if (bCustom === true) {                

            sMsg = "A blank product item has added to the cart. Edit the details for the ";
            sMsg += "custom item, and then click Save Changes to save the custom item to the order.";
            alert(sMsg);
